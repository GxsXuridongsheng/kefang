              ...
              <TR>
                <TD vAlign=top>
                  ...
                  <TABLE height=500 cellSpacing=0 cellPadding=0 width=898 align=center border=0>
                    ...
                    <TR>
                      <TD vAlign=top>
<%		String keyword=Common.toChineseAndTrim(request.getParameter("keyword"));
    cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from room where type like '%"+keyword+"%'");//得到信息总数
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from room where type like '%"+keyword+"%' order by rid", 6);
  ...
  <TR>
    <TD vAlign=top>
      <TABLE height=22 cellSpacing=0 cellPadding=0 width=882 align=center border=0>
        ...
        <TD class=hui12 align=center width=135><%=pagelist2.get(4).toString()  %></TD>
        <TD class=hui12 align=center width=135><%=pagelist2.get(1).toString()  %>元</TD>
          <TD class=hui12 align=center width=135><%=pagelist2.get(5).toString()  %></TD>
