  ...
  <form name="form1" method="post" action="<%=basePath %>AdminServlet">
    <table width="500" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <input type="button" onclick="checkaa()" value="" style="width:130px; height:30px; background-image:url(<%=basePath %>admin/images/admin_login_button.png); border:0; background-color: transparent; "/></td>
      </tr>
    </table>
  </form>
</div>
